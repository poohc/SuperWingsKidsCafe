		...
		if($(this).hasClass("active")) {
			...
			// and in the process of switching views!
  			...
  			if(theid === "view13") {
				...
				$("#view11").children("img").attr("src","/resources/images/switch_11.png");
				
				$("#view12").removeClass("active");
				$("#view12").children("img").attr("src","/resources/images/switch_12.png");
			
				var theimg = $(this).children("img");
				theimg.attr("src","/resources/images/switch_13_active.png");
				...
				$("#view13").children("img").attr("src","/resources/images/switch_13.png");
			
				var theimg = $(this).children("img");
				theimg.attr("src","/resources/images/switch_12_active.png");
				...
				var theimg = $(this).children("img");
				theimg.attr("src","/resources/images/switch_11_active.png");
